  ...
  if (items.length === 0) {
    return (
      <div className="mx-auto max-w-lg px-4 py-20 text-center">
        <ShoppingCart
          className="mx-auto mb-4 h-16 w-16 text-ink-3"
          strokeWidth={1}
        />
      ...
      <div className="mb-10 flex items-center justify-center gap-0">
        {STEPS.map((s, i) => (
          <div key={s} className="flex items-center">
            ...
            {i < STEPS.length - 1 && (
              <div
                className={`mr-4 h-px w-8 sm:w-12 ${i < currentIdx ? "bg-brand" : "bg-line"}`}
              />
            )}
          </div>
        ))}
        ...
        <div className="lg:col-span-2">
          {step === "address" && (
            <div className="animate-fade-in">
              ...
              <p className="mt-1 mb-8 text-sm text-ink-2">
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3 rounded-xl border border-line p-4">
                  <Truck
                    className="h-5 w-5 flex-shrink-0 text-ink"
                    strokeWidth={1.75}
                  />
                  <div>
            ...
            <div className="mt-5 border-t border-line pt-5">
              ...
              {activePromo ? (
                <div className="mt-1.5 flex items-center justify-between rounded-lg border border-brand/30 bg-brand/5 px-4 py-2.5">
                  ...
                  <button
                    ...
                    className="text-ink-3 hover:text-sale transition-colors"
              ...
              {!activePromo && (
                <p className="mt-2 text-xs text-ink-3">
                  Try: SAVE10, WELCOME20, SAVE50, FLASHSALE, BULK5
                </p>
              )}
            </div>
          </div>
