      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mb-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {bulkBenefits.map((benefit) => (
            <div key={benefit.title} className="rounded-xl border bg-white p-5">
          ...
          <div className="rounded-xl border bg-white p-8">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <textarea className="flex min-h-[120px] w-full rounded-md border border-line bg-white px-3 py-2 text-sm" placeholder="Products, quantities, timeline, budget..." />
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-xl border bg-white p-6">
              ...
              <div className="flex flex-wrap gap-2">
                {industries.map((ind) => (
                  <span key={ind} className="rounded-full bg-bg2 px-3 py-1 text-xs font-medium">
                    {ind}
                  </span>
                ))}
              </div>
            ...
            <div className="rounded-xl border bg-white p-6">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:corporate@tradehubuae.com" className="text-brand hover:underline">corporate@tradehubuae.com</a>
                </div>
                <div className="flex items-center gap-2">
